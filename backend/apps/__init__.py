...
# Construire le chemin vers le répertoire de base du projet
...
INSTALLED_APPS = [
    ...
    # Applications locales - AVEC le préfixe 'apps.'
    'apps.users',
    'apps.data',
    'apps.prediction',
    'apps.alerts',
...
# Modèle utilisateur personnalisé - AVEC le préfixe 'apps.'
